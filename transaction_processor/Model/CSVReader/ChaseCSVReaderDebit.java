/******
 ...
 Date: 12/04/2022
 File: Model.Transaction.ChaseCSVReaderDebit.java
 ******/
 ...
 */
public class ChaseCSVReaderDebit implements CSVReader{
    ...
    public IList<ITransaction> populate(String path)throws IOException {
        ...
        while ((line = bufferedReader.readLine()) != null) {
            try {
                ...
                amount = Double.parseDouble(stringList.get(3));
                date = dateFormatter.parse(stringList.get(1));
                description = stringList.get(2);
                category = TransactionCategory.getTransactionCategory(stringList.get(0).toUpperCase());
