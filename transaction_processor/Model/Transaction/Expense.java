/******
 ...
 Date: 12/04/2022
 File: Model.Transaction.Expense.java
 ******/
...
/**
 * This class represents an Expense transaction, differentiated by a transaction number starting with 2. Expenses are always
 * negative.
 */
public class Expense extends Transaction {
    ...
    /**
     * Constructor method to set the transaction's data, as well as its transaction number in relation to all the expenses
     *  instantiated so far.
     ...
     * @throws IllegalArgumentException for a positive amount argument
     */
    public Expense(Date date, double amount, String description, TransactionCategory category) throws IllegalArgumentException{
        super(date,amount,description,category);
        if(amount>0){
            throw new IllegalArgumentException("Expense amount cannot be > 0");
        }
        this.transactionNumber = 200000+count;
        count ++;
    }

    /**
     * Returns a transaction's transaction number (Expense transactions always start with 2)
     * @return a transaction's transaction number (Expense transactions always start with 2)
     */
    @Override
    ...
    public String toString(){
        return "EXPENSE:"+super.toString()+", Model.Transaction#: "+transactionNumber;
    }
    ...
    public boolean equals(Object other){
        ...
        return  (((Expense) other).getDate().equals(this.date)
                ...
                && ((Expense) other).getDescription().equals(this.description)
